        ...
        <div class="container">
          ...
          <div class="row">
              ...
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                 <span class="card-text">{{$product->nama_produk}} - {{$product->nama_merk}}</span> <br>
                 <span>RP {{$product->harga_produk}} /kg</span>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">Lihat Produk</button>
                       <a href="/add_cart/{{$product->id}}" class="btn btn-sm btn-outline-secondary">Tambah ke Cart</a>
                    </div>
                  </div>
                </div>
              </div>
